...
pub async fn get_peer_with_proxy_protocol(tcp_stream: &mut tokio::net::TcpStream) -> Result<ConnectionTuple, ProxyError> {
    ...
    match proxyhdr {
        ProxyHeader::Version1 { family, source, source_port, destination, destination_port, .. } => {
