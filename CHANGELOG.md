...
## 2021-10-29 libunftp 0.19.0

_tag: libunftp-0.19.0_

- [387] (https://github.com/bolcom/libunftp/pull/387) **Breaking** Introduce server health state indicator. This indication will be populated to the metrics. Storage backeds should indicate if the error is due to server failure or not. See exmples in the merge request.
