...
pub fn main() -> std::io::Result<()> {
    ...
    let mut runtime = tokio_compat::runtime::Builder::new().build()?;

    let service_account_key = runtime.block_on_std(yup_oauth2::read_service_account_key(&"key.json".to_string()))?;
